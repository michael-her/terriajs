...
var createGlobalBaseMapOptions = function(terria, bingMapsKey) {
  ...
  //     image: require("../../wwwroot/images/natural-earth_kr.png"),
  ...
  // result.push(
  //   new BaseMapViewModel({
  //     image: require("../../wwwroot/images/black-marble_kr.png"),
  ...
  positron.url = "https://basemaps.cartocdn.com/light_nolabels/";
  ...
  result.push(
    new BaseMapViewModel({
      image: require("../../wwwroot/images/positron_kr.png"),
  ...
  darkMatter.url = "https://basemaps.cartocdn.com/dark_nolabels/";
  ...
  result.push(
    new BaseMapViewModel({
      image: require("../../wwwroot/images/dark-matter_kr.png"),
