...
function createBingBaseMapOptions(terria, bingMapsKey) {
  ...
  result.push(
    new BaseMapViewModel({
      image: require("../../wwwroot/images/bing-aerial-labels_kr.png"),
  ...
  result.push(
    new BaseMapViewModel({
      image: require("../../wwwroot/images/bing-aerial_kr.png"),
  ...
  result.push(
    new BaseMapViewModel({
      image: require("../../wwwroot/images/bing-maps-roads_kr.png"),
