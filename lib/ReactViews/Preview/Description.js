  ...
  render() {
    ...
    return (
      <div className={Styles.description}>
        ...
        >
          {/* michael: column descriptions */}
          <If
            condition={
              defined(catalogItem.metadata.columnMetadata) &&
              get(catalogItem.metadata.columnMetadata, 'featureTypes[0].properties', []).length > 0
            }
          >
