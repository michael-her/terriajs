...
const ObserveModelMixin = {
  ...
  // react_devtools_backend.js:2557 Warning: componentWillMount has been renamed,
  // and is not recommended for use. See https://fb.me/react-unsafe-component-lifecycles for details.
  // componentWillMount() {
