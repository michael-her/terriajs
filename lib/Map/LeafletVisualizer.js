...
LeafletGeomVisualizer.prototype._updatePoint = function(
  ...
  var show =
    ...
    Property.getValueOrDefault(pointGraphics._show, time, true, undefined, entity);
  if (!show) {
  ...
  var position = Property.getValueOrUndefined(entity._position, time, undefined, entity);
  if (!defined(position)) {
    cleanPoint(entity, featureGroup, entityDetails);
    return;
  }
  ...
  //TODO 채움 추가.
  var fill = pointGraphics.fill;
  var outline = pointGraphics.outline;
...
LeafletGeomVisualizer.prototype._updatePolygon = function(
  ...
  var show =
    entity.isAvailable(time) &&
    Property.getValueOrDefault(polygonGraphics._show, time, true, undefined, entity);
  if (!show) {
  ...
  var fill = Property.getValueOrDefault(polygonGraphics._fill, time, true, undefined, entity);
  ...
  var material = Property.getValueOrUndefined(polygonGraphics._material, time, undefined, entity);
  var fillColor;
...
LeafletGeomVisualizer.prototype._updateBillboard = function(
  ...
  var show =
    entity.isAvailable(time) &&
    Property.getValueOrDefault(markerGraphics._show, time, true, undefined, entity);
  if (show) {
    position = Property.getValueOrUndefined(entity._position, time, undefined, entity);
  ...
  var scale = Property.getValueOrDefault(markerGraphics._scale, time, 1.0, undefined, entity);
...
LeafletGeomVisualizer.prototype._updateLabel = function(
  ...
  var show =
    entity.isAvailable(time) &&
    Property.getValueOrDefault(labelGraphics._show, time, true, undefined, entity);
  if (show) {
    position = Property.getValueOrUndefined(entity._position, time, undefined, entity);
    show = defined(position);
  }
  ...
  var text = Property.getValueOrDefault(labelGraphics._text, time, undefined, undefined, entity);
  var font = Property.getValueOrDefault(labelGraphics._font, time, undefined, undefined, entity);
  var scale = Property.getValueOrDefault(labelGraphics._scale, time, 1.0, undefined, entity);
...
LeafletGeomVisualizer.prototype._updatePolyline = function(
  ...
  var show =
    entity.isAvailable(time) &&
    Property.getValueOrDefault(polylineGraphics._show, time, true, undefined, entity);
  if (show) {
    positions = Property.getValueOrUndefined(polylineGraphics._positions, time, undefined, entity);
  ...
  var outline = polylineGraphics.outline
