...
GeowaveVectorTileImageryProvider.prototype._requestImage = function(
  ...
  const compareZoomFn = it => {
    return this._maximumLevel - it.tile.level // lowest level to right for delete/cancel
  }
