...
var GeowaveCatalogGroup = require("./GeowaveCatalogGroup");
import GeowaveVectorTileCatalogItem from './GeowaveVectorTileCatalogItem'
import GeowaveTwkbCatalogItem from './GeowaveTwkbCatalogItem'
import FlatGeoBufCatalogItem from './FlatGeoBufCatalogItem'
...
var registerCatalogMembers = function() {
  ...
  createCatalogMemberFromType.register("gwMvt", GeowaveVectorTileCatalogItem);
  createCatalogMemberFromType.register("gwTwkb", GeowaveTwkbCatalogItem);
  createCatalogMemberFromType.register("FlatGeoBuf", FlatGeoBufCatalogItem);
  ...
  createCatalogMemberFromType.register("geowave", GeowaveCatalogGroup);
