...
var Metadata = function() {
  ...
  /**
   * Gets or sets the metadata group for the columns
   */
  this.columnMetadata = new MetadataItem();

  /**
   * Gets or sets the metadata group for the layer
   */
  this.layerMetadata = new MetadataItem();

  /**
   * Gets or sets the metadata group for the layer to show.
   */

  this.viewingLayerMetaData = new MetadataItem();
