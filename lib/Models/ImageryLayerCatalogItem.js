...
ImageryLayerCatalogItem.prototype.updateLayerVisual = function(layer, props) {
 ...
 */
ImageryLayerCatalogItem.prototype.refresh = debounce(function() {
  if (!defined(this._imageryLayer)) {
    return;
  }

  if (defined(this._refresh)) {
    this._refresh()
  }
  ...
  this._imageryLayer._imageryCache = {}
          ...
          .otherwise(function(e) {
            ...
            if (e.statusCode >= 400 && e.statusCode < 500) {
              ...
              if (catalogItem.ignoreUnknownTileErrors) {
                ...
                const url = getUrlForImageryTile(
                  imageryProvider,
                  tileProviderError.x,
                  tileProviderError.y,
                  tileProviderError.level
                ...
                failTile({
                  name: url
                    ? i18next.t("models.imageryLayer.unknownTileErrorTitle")
                    : tileProviderError.name,
                  message: url
                    ? i18next.t("models.imageryLayer.unknownTileErrorMessage", {url})
                    : `${tileProviderError.message}\n${tileProviderError.error.stack}`
                });
              }
            } else {
