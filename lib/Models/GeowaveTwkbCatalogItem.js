        ...
        if (defined(that.data)) {
          ...
          if (zipFileRegex.test(that.url)) {
            ...
            jsonPromise = loadTwkb(
              proxyCatalogItemUrl(that, that.url, "0d"),
              that.token,
          ...
          return jsonPromise
            .then(function(response) {
              ...
              // Accu 3.0 에서는 응답 데이터에 data 가 없음.
              const json = that.accuVersion === 3 ? {data:parseJson} : parseJson
            ...
            .otherwise(function(e) {
              ...
              throw new TerriaError({
                sender: that,
                title: e.message || i18next.t("models.gwTwkb.couldNotLoadTitle"),
