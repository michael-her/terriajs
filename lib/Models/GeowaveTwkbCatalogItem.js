...
var GeowaveTwkbCatalogItem = function(terria, url) {
  ...
  /**
    ...
    * @default 1.0
    */
  this.thickness = new CallbackProperty((time, result) => this.visual.thickness, false)
  ...
  this.extrudedHeight = new CallbackProperty((time, result) => this.visual.extruded ? this.visual.extrudedHeight : undefined, false)
