...
GeowaveCatalogGroup.prototype._load = function() {
  ...
  return loadJson(url)
    ...
    .otherwise(function(e) {
      ...
      const corsRelated = i18next.t("models.GeowaveCatalogGroup.groupNotAvailableCorsMessage", {appName: that.terria.appName})
      const message = `${i18next.t("models.GeowaveCatalogGroup.groupNotAvailableMessage", {email})} ${!that.forceProxy ? corsRelated : ''}`
      throw new TerriaError({
        sender: that,
