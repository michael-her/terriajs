...
var GeowaveTwkbCatalogItem = function(terria, url) {
  ...
  /**
   * Gets or sets the URL from which the {@link GeowaveTwkbCatalogItem#data} was obtained.  This will be used
...
inherit(DataSourceCatalogItem, GeowaveTwkbCatalogItem);
  ...
  metadata: {
    get: function() {
      ...
      result.dataSourceErrorMessage = i18next.t(
        "models.gwTwkb.dataSourceErrorMessage"
      );
      result.serviceErrorMessage = i18next.t(
        "models.gwTwkb.serviceErrorMessage"
      );
      return result;
    }
  },
...
function loadGeoJson(geoJsonItem) {
  ...
  var options = {
    ...
    polygonStroke: getColor(defaultValue(style.stroke, DEFAULT_COLOR)),
