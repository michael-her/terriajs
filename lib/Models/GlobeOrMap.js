...
var GeowaveVectorTileImageryProvider = require("../Map/GeowaveVectorTileImageryProvider");
...
GlobeOrMap.prototype._highlightFeature = function(feature) {
  ...
  if (defined(feature)) {
    ...
    if (defined(feature.polygon)) {
      ...
      const entity = feature.cesiumEntity || feature;

      var polygonOutline = entity.polygon.outline;
      var polygonOutlineColor = entity.polygon.outlineColor;
      var polygonMaterial = entity.polygon.material;

      entity.polygon.outline = true;
      entity.polygon.outlineColor = Color.fromCssColorString(
        this.terria.baseMapContrastColor
      );
      const currentColor = polygonMaterial.getValue(undefined, undefined, entity).color;
      entity.polygon.material = Color.fromCssColorString(
        this.terria.baseMapContrastColor
      ).withAlpha(currentColor.alpha);

      this._removeHighlightCallback = function() {
        entity.polygon.outline = polygonOutline
        entity.polygon.outlineColor = polygonOutlineColor
        entity.polygon.material = polygonMaterial
        // const highlightFeatureColor = entity.polygon.material.getValue(undefined, undefined, entity)
        //   .color;
        // entity.polygon.outline = polygonOutline;
        // entity.polygon.outlineColor = polygonOutlineColor
        //   .getValue(undefined, undefined, entity)
        //   .withAlpha(polygonOutlineColor.alpha);
        // entity.polygon.material.color = currentColor.withAlpha(
    ...
    if (defined(feature.polyline)) {
      ...
      var polylineMaterial = entity.polyline.material;
      var polylineWidth = entity.polyline.width;
      ...
      this._removeHighlightCallback = function() {
        entity.polyline.material = polylineMaterial;
    ...
    if (!hasGeometry) {
      if (
        ...
        (feature.imageryLayer.imageryProvider instanceof GeowaveVectorTileImageryProvider ||
          feature.imageryLayer.imageryProvider instanceof MapboxVectorTileImageryProvider)
      ) {
